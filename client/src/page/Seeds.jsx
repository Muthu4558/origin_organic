...
const DiabeticsMix = () => {
  ...
  useEffect(() => {
    startLoading();
    axios
      .get(`${import.meta.env.VITE_APP_BASE_URL}/api/products/Seeds`)
      .then((res) => {
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8">
            ...
            <div className="w-full lg:w-2/3 text-center lg:text-left">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-tight text-gray-900">
                Explore <span style={{ color: BRAND }}>Seeds</span>
              </h1>

              <p className="mt-4 text-gray-600 max-w-2xl mx-auto lg:mx-0">
                Discover our curated selection of Seeds products, specially
            ...
            <div className="py-20 text-center">
              <div className="inline-flex flex-col items-center gap-4">
                ...
                <p className="text-gray-600 max-w-xl mx-auto">
                  No Seeds products match your filters. Try adjusting filters or browse other categories.
                </p>
                <button
                  onClick={clearFilters}
