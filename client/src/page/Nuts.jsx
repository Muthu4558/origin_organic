...
const Nuts = () => {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .catch((err) => {
        console.error("Error loading nuts products:", err);
        setProducts([]);
        setFilteredProducts([]);
      })
      .finally(() => stopLoading());
          ...
          <div className="flex flex-col lg:flex-row items-center gap-10">
            <div className="lg:w-2/3 text-center lg:text-left">
              <h1
                ...
                style={{ color: "#111827" }}
              >
                Explore <span style={{ color: BRAND }}>Nuts & Dry Fruits</span>
              </h1>
              <p className="mt-4 text-gray-600 max-w-2xl mx-auto lg:mx-0">
                Premium nuts and dry fruits — almonds, cashews, raisins, pistachios and curated mixes.
                Fresh, clean, and packed for long shelf life.
              </p>
              ...
              <div className="mt-6 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 w-full">
                <div className="flex items-center gap-2 bg-white/90 border border-gray-200 px-4 py-2 rounded-full shadow-sm w-full sm:w-auto">
                  ...
                  <input
                    ...
                    placeholder="Search nuts, brands or mixes..."
                    className="outline-none text-sm bg-transparent w-full"
                    aria-label="Search nuts products"
                  />
                </div>
